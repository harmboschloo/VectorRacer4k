	...
	private V()	{
		...
		while( true ) {
			...
			if ( _state == NEW_RACE_STATE ) {
		        ...
		        int[][] currentPoints = new int[2][500]; // should be larger than about 250
		        int[][] changedPoints = new int[2][500];
		        ...
		        final int X = 0;
		        final int Y = 1;
		        currentPoints[X][0] = SF_X-2*GRID_SIZE-1;
		        currentPoints[Y][0] = SF_Y;
		        int nCurrent = 1;
		        int nChanged = 0;
		        _trace[currentPoints[0][0]][currentPoints[1][0]] = 1;
		        while ( nCurrent > 0 ) {
